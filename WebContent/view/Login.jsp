...
<body>
	...
	<div>
		<table class="box"
			style="background-color: #eeeeee; padding: 5px 5px; font-size: 13px; width: 760;">
			<tr>
				<td align="left">セキュリティ対策を見直しませんか？ 詳細は <a
					href="http://static.id.rakuten.co.jp/app/static/common/about_security/jpn/">こちら</a>
				</td>
				<td align="right"><a
					href="https://www.jpcert.or.jp/pr/stop-password.html"> <img
						width="97.58" height="45" src="E:\web\セキュリティ対策.png">
				</a></td>
			</tr>
		</table>
	</div>
